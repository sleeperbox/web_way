...
class FamilyLove extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidMount() {
    axios({
      method: "post",
      url: "http://192.168.100.33:8080/api/posting/home/family-love",
      headers: {
                    ...
                    {data.fotocontent === null ? (
                      <div>
                        <CardMedia
                          ...
                          image={"http://aprizal.com/public/icon/icon/family.png"}
                        />
                      </div>
                    ) : (
                      <div>
...
FamilyLove.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(FamilyLove);
