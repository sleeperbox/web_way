        ...
        <Grid item xs={12} sm={6}>
          <List>
            ...
            <ListItem>
              ...
              <ListItemText
                primary="Friends"
                secondary={total_friends + " people"}
              />
            </ListItem>
            <ListItem>
          ...
          <List>
            ...
            <ListItem>
              <ListItemText
                style={textStyling}
                primary="Thanks"
                secondary={total_thanks + " thanked"}
              />
            ...
            <ListItem>
              <ListItemText
                style={textStyling}
                primary="Topic Follow"
                secondary={followed_topic}
              />
    ...
    return (
      <div>
        ...
        <Paper style={{ padding: 10 }}>
          <Fab
            style={{ position: "absolute", margin: 10, right: 125, zIndex: 99 }}
            size="small"
